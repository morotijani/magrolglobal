	...
	<div class="container">
		<div class="row g-4 g-lg-5 justify-content-center">
			...
			<div class="col-sm-6 col-md-4 text-center position-relative">
				...
				<div class="px-4">
					<!-- Image -->
					<img src="<?= PROOT; ?>assets/media/step-3.svg" class="w-150px mb-3" alt="">
					<!-- Title -->
					<h5>Search Choice</h5>
					<p class="mb-0">Total 630+ goods you can import</p>
				</div>	
			</div>
			...
			<div class="col-sm-6 col-md-4 position-relative text-center pt-0 pt-lg-5">
				...
				<div class="px-4">
					<!-- Image -->
					<img src="<?= PROOT; ?>assets/media/step-2.svg" class="w-150px mb-3" alt="">

					<!-- Title -->
					<h5>Select Destination</h5>
					<p class="mb-0">Select the destination in Ghana you want to import goods</p>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 text-center">
				<div class="px-4">
					<!-- Image -->
					<img src="<?= PROOT; ?>assets/media/step-1.svg" class="w-150px mb-3" alt="">

					<!-- Title -->
					<h5>Easy to Import</h5>
					<p class="mb-0">With an easy and fast import process</p>
				</div>	
			</div>
		</div>
	</div>
		...
		<div class="bg-light rounded-3 position-relative p-4 p-sm-5">
			...
			<div class="row align-items-center position-relative">
				<div class="col-lg-8">
					<!-- Title -->
					<div class="d-flex">
						<h3>It's time to import</h3>
						<img src="<?= PROOT; ?>assets/media/04.svg" class="h-40px ms-3" alt="">
					</div>
					<p class="mb-3 mb-lg-0">Import goods from Dubai to Ghana with ease. Our team will handle the logistics from start to finish.</p>
				</div>
				<!-- Content and input -->
